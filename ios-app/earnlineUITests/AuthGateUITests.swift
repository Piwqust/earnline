...
final class AuthGateUITests: XCTestCase {
    ...
    func testEntryOffersSupportedProvidersAndAnAccessiblePairingRoute() {
        let app = launchAuthGate()
        ...
        XCTAssertEqual(google.frame.minX, github.frame.minX, accuracy: 0.5)
        XCTAssertEqual(google.frame.maxX, github.frame.maxX, accuracy: 0.5)
