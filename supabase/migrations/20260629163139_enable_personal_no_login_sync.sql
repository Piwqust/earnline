...
alter table public.earnline_clients add column if not exists workspace_id text not null default 'your-workspace-id';
alter table public.earnline_entries add column if not exists workspace_id text not null default 'your-workspace-id';
alter table public.earnline_headings add column if not exists workspace_id text not null default 'your-workspace-id';
alter table public.earnline_tombstones add column if not exists workspace_id text not null default 'your-workspace-id';
...
alter table public.earnline_clients add constraint earnline_clients_workspace_id_check check (workspace_id = 'your-workspace-id');
alter table public.earnline_entries add constraint earnline_entries_workspace_id_check check (workspace_id = 'your-workspace-id');
alter table public.earnline_headings add constraint earnline_headings_workspace_id_check check (workspace_id = 'your-workspace-id');
alter table public.earnline_tombstones add constraint earnline_tombstones_workspace_id_check check (workspace_id = 'your-workspace-id');
